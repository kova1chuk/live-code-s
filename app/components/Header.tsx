...
export default function Header() {
  ...
  const sections = {
    'Parsing & Formatting': {
      ...
      items: [
        ...
        { name: 'Date Formatting', path: '/parsing-formatting/date-formatting' },
        { name: 'String Template', path: '/parsing-formatting/string-template' }
      ]
    },
    'Object & Functional': {
      ...
      items: [
        ...
        { name: 'Function Composition', path: '/object-functional/function-composition' },
        { name: 'Currying', path: '/object-functional/currying' },
        { name: 'Prototype Chain', path: '/object-functional/prototype-chain' },
        { name: 'Higher-Order Functions', path: '/object-functional/higher-order' }
      ]
    },
    'Data Structures': {
    ...
    'Array & String': {
      ...
      items: [
        { name: 'Array Methods', path: '/array-string-manipulation/array-methods' },
        { name: 'String Manipulation', path: '/array-string-manipulation/string-manipulation' },
        { name: 'Matrix Operations', path: '/array-string-manipulation/matrix' }
      ]
    },
    'Sorting & Searching': {
    ...
    'Recursion & Backtracking': {
      ...
      items: [
        { name: 'Recursive Functions', path: '/recursion-backtracking/recursive' },
        { name: 'Backtracking', path: '/recursion-backtracking/backtracking' },
        { name: 'Tree Traversal', path: '/recursion-backtracking/tree-traversal' }
      ]
    },
    'Promises & Async': {
      path: '/promises-async',
  ...
  const renderNavItems = () => (
    <>
      {Object.entries(sections).map(([section, { path: sectionPath, items }]) => (
