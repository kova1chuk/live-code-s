...
interface MoveZeroesChallengeContentProps {
  title: string;
  description: string;
  examples: Example[];
  testCases: MoveZeroesTestCase[];
  solutions: Solution[];
  initialCode: string;
...
export default function MoveZeroesChallengeContent({
  title,
  description,
  examples,
  testCases,
  ...
  submitButtonText = "Move Zeroes",
}: MoveZeroesChallengeContentProps) {
  const solutionTabs = [
