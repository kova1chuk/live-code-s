...
interface FlattenArrayTestRunnerProps {
  testCases: TestCase[];
  code: string;
  onRunTests: () => void;
}

export default function FlattenArrayTestRunner({
  testCases,
  code,
  onRunTests,
}: FlattenArrayTestRunnerProps) {
  ...
  const runTests = () => {
    ...
    try {
      ...
      const flattenArray = new Function(code + "\nreturn flattenArray;")();

      const testResults = testCases.map((testCase) => {
        try {
          const actual = flattenArray(testCase.input);
          const passed =
