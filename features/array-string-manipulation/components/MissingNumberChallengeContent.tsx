...
interface MissingNumberTestCase {
  input: number[];
  expected: number;
  description?: string;
}
...
interface MissingNumberChallengeContentProps {
  title: string;
  description: string;
  examples: Example[];
  testCases: MissingNumberTestCase[];
  solutions: Solution[];
  initialCode: string;
...
export default function MissingNumberChallengeContent({
  title,
  description,
  examples,
  testCases,
  ...
  inputPlaceholder = "e.g. 3,0,1",
  submitButtonText = "Find Missing Number",
}: MissingNumberChallengeContentProps) {
  const solutionTabs = [
